...
Vcity.allCity = ['北京|beijing|bj','上海|shanghai|sh', '重庆|chongqing|cq',  '深圳|shenzhen|sz', '广州|guangzhou|gz', '杭州|hangzhou|hz',
    ...
    '黑河|heihe|hh', '海拉尔|hailaer|hle', '哈尔滨|haerbin|heb', '海口|haikou|hk', '湖州|huzhou|hz','黄山|huangshan|hs', '邯郸|handan|hd',
    '汉中|hanzhong|hz', '和田|hetian|ht', '晋江|jinjiang|jj', '锦州|jinzhou|jz', '景德镇|jingdezhen|jdz',
    '嘉峪关|jiayuguan|jyg', '井冈山|jinggangshan|jgs', '济宁|jining|jn', '九江|jiujiang|jj', '佳木斯|jiamusi|jms', 
...
Vcity.allCity = ['北京|beijing|bj','湖州|huzhou|hz','哈尔滨|haerbin|heb','南昌|nanchang|nc','天津|tianjin|tj','杭州|hangzhou|hz','大连|dalian|dl','绍兴|shaoxing|sx',
    '孝感|xiaogan|xg','上海|shanghai|sh','宁波|ningbo|nb', '深圳|shenzhen|sz','西安|xian|xa','武汉|wuhan|wh','厦门|xiamen|xm', '福州|fuzhou|fz',
    '广州|guangzhou|gz', '重庆|chongqing|cq', '青岛|qingdao|qd','温州|wenzhou|wz','昆明|kunming|km','济南|jinan|jn','泉州|quanzhou|qz'];
    ...
    linkEvent:function(){
        ...
        for(var i=0,n=links.length;i<n;i++){
            links[i].onclick = function(){
				...
				//选中城市
                Vcity.CitySelected(that.input.value);
            }
        }
    },
    ...
    KeyboardEvent:function(event,keycode){
        ...
        switch(keycode){
            ...
            case 13: // enter键
                ...
                //选中城市
                Vcity.CitySelected(this.input.value);
                break;
            default:
                break;
        }
